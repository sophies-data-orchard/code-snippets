...
{'Computer Science': 
  ...
  'Electrical Engineering': {'students': ['David', 'Eva', 'Frank'], 
                             'courses': ['Circuits', 'Electromagnetics', 'Signal Processing']
                             }
}
{'History': 
...
for word in s:
    ...
    # print(itemset)
    result.append(itemset.copy())  # Append a copy of itemset to result
    # result.append(itemset) can't use this, result is not right
print(result)

        result.append(itemset.add(letter))
    print(result) 
type(s[0])    
print(result)
